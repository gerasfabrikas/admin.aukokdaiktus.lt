...
<form method="post" action="register.php" name="registerform" enctype="multipart/form-data">   
	...
	<input id="user_name" type="text" pattern="[a-zA-Z0-9]{2,64}" name="user_name" required="required" />
	<br>
	...
	<?php if(isset($_GET['juridinis'])) : ?>
		...
		<input id="user_orgname" type="text" maxlength="128" name="user_orgname" required="required" />
		<br>
		...
		<input id="user_code1" type="text" maxlength="9" name="user_code1" required="required" />
		<br>
	...
	<?php else : ?>
		...
		<input id="user_fname" type="text" maxlength="32" name="user_fname" required="required" />
		<br>
		<label for="user_lname">Pavardė<span class="reqfield">*</span></label>
		<input id="user_lname" type="text" maxlength="32" name="user_lname" required="required" />
	...
	<input id="user_address" type="text" maxlength="256" name="user_address" required="required" />
	<br>
	<label for="user_city">Miestas arba rajonas<span class="reqfield">*</span></label>
	<select id="user_city" name="user_city">
		<?php foreach($citiesList as $key => $city) echo '<option value="'.$key.'">'.$city.'</option>'; ?>
	</select>
	<br>
	<label for="user_phone">Telefonas<span class="reqfield">*</span><br><small>formatu 37012345678</small></label>
	<input id="user_phone" type="text" maxlength="11" name="user_phone" value="370" required="required" />
	<br>
	<br>
