...
<br><br>
<a href="?p=editneedy"><i class="fa fa-asterisk"></i> Sukurti stokojantįjį</a>
<?php if(isAdmin()) : ?> &middot;
<a href="?p=catneedy&subp=1"><i class="fa fa-tags"></i> Fizinių a. kategorijos</a> &middot;
<a href="?p=catneedy&subp=2"><i class="fa fa-tags"></i> Juridinių a. kategorijos</a>
<?php endif; ?>